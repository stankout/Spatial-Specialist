...
export function SpatialConsultationHub({ locale,media={},draftPreview=false }: { locale: Locale;media?:Partial<Record<MediaSlotKey,MediaAsset|null>>;draftPreview?:boolean }) {
  const vi = locale === "vi";
  ...
  return <div className="space-hub">
    ...
    <section data-visual-section="analysis" data-tone="glass" className="space-analysis story-surface-glass story-text-dark">
