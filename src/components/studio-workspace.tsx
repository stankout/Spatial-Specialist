...
import {PageCompositionManager} from "@/components/page-composition-manager";
...
export async function StudioWorkspace({section}:{section:"media"|"assets"|"embeds"}){
 ...
 const [assets,assignments,embeds,embedAssignments,sections]=access.enabled?await Promise.all([new LocalMediaStorageProvider().list(),listAssignments(),listEmbeds(),listEmbedAssignments(),listMediaSections()]):[[],[],[],[],[]];
